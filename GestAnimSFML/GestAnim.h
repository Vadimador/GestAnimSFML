...
public:
	...
	virtual void firstStart(); // m�thode vide pas obligatoire, � surcharger uniquement si votre GestAnim doit rafraichir ses variables si elle est activ�e � la cha�ne.
